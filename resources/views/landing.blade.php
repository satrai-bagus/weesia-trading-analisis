<x-layouts.app title="Weesia - FibPath Analyzer" :with-csrf="false">
    @php
        ...
        $features = [
            [
                ...
                'desc' =>
                    'FibPath Analyzer mempelajari ribuan pola Fibonacci historis dan mendeteksi formasi yang sedang terbentuk pada multi-timeframe.',
                'accent' => 'gold',
            ],
            [
                'icon' => 'activity',
                ...
                'desc' =>
                    'Signal entry, take profit, dan stop loss diperbarui live mengikuti pergerakan harga dengan latensi di bawah 200ms.',
                'accent' => 'emerald',
            ],
            [
                'icon' => 'database',
                ...
                'desc' =>
                    'Setiap analisa, eksekusi, catatan benar atau salah, dan rasionalitas trade tersimpan rapi untuk review.',
                'accent' => 'gold',
            ],
            [
                'icon' => 'trending-up',
                'title' => 'Winrate Analytics',
                'desc' =>
                    'Metrics dihitung otomatis: winrate, expectancy, average R:R, drawdown, dan kurva equity per setup.',
                'accent' => 'emerald',
            ],
            [
                'icon' => 'layers',
                'title' => 'Live Profit Estimator',
                'desc' =>
                    'Estimasi keuntungan setiap analisa berjalan dihitung ulang berdasarkan harga market terbaru.',
                'accent' => 'gold',
            ],
            [
                'icon' => 'shield-check',
                ...
                'desc' =>
                    'Kalkulator position sizing, exposure tracker, dan circuit breaker. Disiplin sebelum diskresi.',
                'accent' => 'emerald',
            ],
        ];
        ...
        $steps = [
            [
                ...
                'title' => 'Capture',
                'desc' =>
                    'FibPath memindai chart, mendeteksi swing high dan swing low, lalu menghitung Fibonacci retracement serta extension otomatis di seluruh timeframe.',
            ],
            [
                'no' => '02',
                'title' => 'Classify',
                'desc' =>
                    'Engine AI mencocokkan pola yang terdeteksi dengan basis data ribuan setup historis untuk menentukan probabilitas tiap formasi.',
            ],
            [
                'no' => '03',
                'title' => 'Compose',
                'desc' =>
                    'Signal dirangkai menjadi rencana trade lengkap: entry zone, target multi-level, stop loss, position size, dan rasionalitas tertulis.',
            ],
            [
                'no' => '04',
                'title' => 'Capture Result',
                'desc' =>
                    'Setiap eksekusi dicatat. Trade selesai akan masuk journal sebagai data benar atau salah untuk analisa lanjutan.',
            ],
        ];
        ...
        $footerColumns = [
            [
                ...
                'links' => [
                    ...
                    ['Live Estimator', '#features'],
                ],
            ],
            [
                'title' => 'Perusahaan',
                'links' => [['Tentang Weesia', '#'], ['Filosofi', '#'], ['Harga', '#pricing'], ['Kontak', '#cta']],
            ],
    ...
    <main class="relative flex-1 overflow-hidden">
                ...
                <div class="flex items-center justify-between rounded-full px-2 py-1 transition-all duration-500"
                    ...
                    <a class="group flex items-center gap-3 pl-2" href="#top">
                        ...
                        <span class="leading-none">
                            <span class="font-display text-ink-50 block text-lg tracking-wide">Weesia</span>
                            <span class="text-gold-400/80 block font-mono text-[9px] uppercase tracking-[0.25em]">FibPath
                                Analyzer</span>
                        </span>
                    </a>
        ...
        <section class="relative isolate flex min-h-[100svh] items-center overflow-hidden pb-20 pt-32" id="top">
            ...
            <div class="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-16 px-6 lg:grid-cols-12 lg:gap-8">
                <div class="lg:col-span-7">
                    <div class="reveal border-gold-500/20 bg-ink-900/60 inline-flex items-center gap-2 rounded-full border px-4 py-1.5 backdrop-blur-md"
                        ...
                        <span class="text-gold-200/90 font-mono text-[10px] uppercase tracking-[0.3em]">Weesia &middot;
                            Quant Intelligence</span>
                    </div>

                    <h1 class="reveal font-display text-ink-50 mt-8 text-5xl leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl xl:text-[5.5rem]"
                    ...
                    <p class="reveal text-ink-200 mt-8 max-w-xl text-lg leading-relaxed" style="--reveal-delay: 260ms;">
                        <span class="text-gold-200">FibPath Analyzer</span> &mdash; sistem AI milik Weesia yang membaca
                        pola Fibonacci pada market real-time. Setiap analisa, setiap eksekusi, setiap winrate &mdash;
                        terdokumentasi. Estimasi profit dihitung ulang setiap detik mengikuti harga terbaru.
                    </p>

                    <div class="reveal mt-10 flex flex-wrap items-center gap-4" style="--reveal-delay: 340ms;">
                        <a class="from-gold-300 to-gold-500 text-ink-900 group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-b px-7 py-3.5 text-sm font-semibold shadow-[0_10px_40px_-10px_rgba(212,167,44,0.6)] transition-all hover:shadow-[0_18px_60px_-10px_rgba(212,167,44,0.8)]"
                            href="{{ route('login') }}">
                            <span class="relative z-10">Mulai Analisa</span>
                        ...
                        <a class="border-ink-500/40 bg-ink-800/40 text-ink-100 hover:border-gold-500/40 hover:text-gold-100 inline-flex items-center gap-2 rounded-full border px-7 py-3.5 text-sm font-medium backdrop-blur-md transition-all"
                            href="#features">Lihat Sistem</a>
                    </div>

                    <div class="reveal border-ink-700/60 mt-12 flex flex-wrap items-center gap-8 border-t pt-6"
                        style="--reveal-delay: 420ms;">
                        <div>
                            <div class="font-display text-ink-50 text-3xl">74.2<span
                                    class="text-gold-300 ml-0.5 text-base">%</span></div>
                            <div class="text-ink-300 mt-1 font-mono text-[10px] uppercase tracking-[0.2em]">Avg. Winrate
                            </div>
                        </div>
                        <div class="bg-ink-700 hidden h-10 w-px sm:block"></div>
                        <div>
                            <div class="font-display text-ink-50 text-3xl">1.8<span
                                    class="text-gold-300 ml-0.5 text-base">K+</span></div>
                            <div class="text-ink-300 mt-1 font-mono text-[10px] uppercase tracking-[0.2em]">Pola
                                Terdeteksi</div>
                        </div>
                        <div class="bg-ink-700 hidden h-10 w-px sm:block"></div>
                        <div>
                            <div class="font-display text-ink-50 text-3xl">&lt;200<span
                                    class="text-gold-300 ml-0.5 text-base">ms</span></div>
                            <div class="text-ink-300 mt-1 font-mono text-[10px] uppercase tracking-[0.2em]">Latensi
                                Analisa</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="border-gold-500/20 bg-ink-900/80 relative overflow-hidden rounded-3xl border p-6 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)] backdrop-blur-xl"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="animate-pulse-soft h-2.5 w-2.5 rounded-full bg-emerald-400 shadow-[0_0_12px_2px_rgba(47,199,124,0.6)]">
                                    </div>
                                    <span class="font-mono text-xs uppercase tracking-widest text-emerald-300">Free Live
                                        Analysis</span>
                                </div>
                            ...
                            <div class="mt-6 h-28 w-full">
                                <svg class="h-full w-full" viewBox="0 0 320 110">
                                    ...
                                    <path d="M0,80 L40,72 L80,82 L120,60 L160,68 L200,42 L240,50 L280,28 L320,18"
                                        stroke="#fbeeb6" stroke-width="1.5" fill="none" stroke-linecap="round"
                            ...
                            <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-3">
                                ...
                                <div
                                    ...
                                    <div class="text-ink-300 font-mono text-[9px] uppercase tracking-[0.2em]">TP1 -
                                        1.272</div>
                                    <div class="mt-1 min-w-0 break-words font-mono text-sm leading-snug sm:text-[15px]"
                                ...
                                <div
                                    ...
                                    <div class="text-ink-300 font-mono text-[9px] uppercase tracking-[0.2em]">SL -
                                        0.382</div>
                                    <div class="mt-1 min-w-0 break-words font-mono text-sm leading-snug sm:text-[15px]"
                            ...
                            <div class="border-ink-700/60 mt-6 flex items-center justify-between border-t pt-4">
                                <div>
                                    <div class="text-ink-300 font-mono text-[10px] uppercase tracking-[0.2em]">Estimasi
                                        Profit</div>
                                    <div class="font-display {{ str_starts_with($featured['profit'], '-') ? 'text-rose-300' : 'text-emerald-300' }} text-xl"
                                        data-featured-profit>{{ $featured['profit'] }}</div>
                                </div>
                                <div class="text-right">
                                    <div class="text-ink-300 font-mono text-[10px] uppercase tracking-[0.2em]">
                                        Confidence</div>
                                    <div class="flex items-center justify-end gap-2">
                                        <div class="bg-ink-700 h-1.5 w-20 overflow-hidden rounded-full">
                                            <div class="from-gold-400 h-full bg-gradient-to-r to-emerald-400"
                                                data-featured-confidence-bar
                                                style="width: {{ $featured['confidence_width'] }}"></div>
                                        </div>
                                        <span class="text-ink-100 font-mono text-xs"
                                            data-featured-confidence>{{ $featured['confidence'] }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="landing-deferred relative scroll-mt-24 py-32 sm:py-40" id="features">
            <div class="mx-auto max-w-7xl px-6">
                <div class="max-w-3xl">
                    <div class="reveal inline-flex items-center gap-3">
                        <span class="bg-gold-500/60 h-px w-10"></span>
                        <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Sistem Inti</span>
                    </div>
                    ...
                    <p class="reveal text-ink-200 mt-6 max-w-2xl text-base leading-relaxed"
                        style="--reveal-delay: 200ms;">Enam pilar yang membentuk FibPath Analyzer - dari pola hingga
                        eksekusi, dari journal hingga performa.</p>
                </div>
        ...
        <section
            ...
            <div class="relative mx-auto max-w-7xl px-6">
                <div class="max-w-3xl">
                    <div class="reveal inline-flex items-center gap-3">
                        <span class="bg-gold-500/60 h-px w-10"></span>
                        <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Performa</span>
                    </div>
                    <h2 class="reveal font-display text-ink-50 mt-5 text-4xl leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl"
                        style="--reveal-delay: 100ms;">
                    ...
                    <p class="reveal text-ink-200 mt-6 max-w-2xl text-base leading-relaxed"
                        style="--reveal-delay: 200ms;">Setiap metrik dihitung dari trade aktual yang tercatat di
                        journal Weesia - bukan backtest dan bukan estimasi kosong.</p>
                </div>
                ...
                <div
                    ...
                    @foreach ($stats as $index => $stat)
                        <article
                            ...
                            <div class="font-display text-ink-50 mt-6 text-5xl lg:text-6xl">
                                <span class="tabular-nums" data-counter="{{ $stat['value'] }}"
        ...
        <section class="landing-deferred relative scroll-mt-24 py-32 sm:py-40" id="how">
            <div class="mx-auto max-w-7xl px-6">
                <div class="max-w-3xl">
                    <div class="reveal inline-flex items-center gap-3">
                        <span class="bg-gold-500/60 h-px w-10"></span>
                        <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Cara Kerja</span>
                    </div>
                    <h2 class="reveal font-display text-ink-50 mt-5 text-4xl leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl"
                        style="--reveal-delay: 100ms;">
                    ...
                    <p class="reveal text-ink-200 mt-6 max-w-2xl text-base leading-relaxed"
                        style="--reveal-delay: 200ms;">Sebuah pipeline analisa yang dirancang sederhana di permukaan,
                        dalam pada eksekusinya.</p>
                </div>
                        ...
                        <article
                            ...
                            <div class="relative">
                                <div class="inline-flex items-center gap-3">
                                    ...
                                    <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Step
                                        {{ $step['no'] }}</span>
                                </div>
        ...
        <section
            ...
            <div
                class="pointer-events-none absolute -right-32 bottom-1/4 h-80 w-80 rounded-full bg-emerald-500/10 blur-3xl">
            </div>
            ...
            <div class="relative mx-auto max-w-7xl px-6">
                <div class="max-w-3xl">
                    <div class="reveal inline-flex items-center gap-3">
                        <span class="bg-gold-500/60 h-px w-10"></span>
                        <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Harga &middot;
                            Pricing</span>
                    </div>
                    <h2 class="reveal font-display text-ink-50 mt-5 text-4xl leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl"
                        style="--reveal-delay: 100ms;">
                    ...
                    <p class="reveal text-ink-200 mt-6 max-w-2xl text-base leading-relaxed"
                        style="--reveal-delay: 200ms;">Promo awal peluncuran. Akses analisa profesional dengan harga
                        yang masuk akal &mdash; fokus ke disiplin dulu, scale-up nanti.</p>

                    <div class="reveal mt-6 inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1.5 backdrop-blur-md"
                        style="--reveal-delay: 280ms;">
                        <span
                            class="animate-pulse-soft h-2 w-2 rounded-full bg-emerald-400 shadow-[0_0_10px_2px_rgba(47,199,124,0.6)]"></span>
                        <span class="font-mono text-[10px] uppercase tracking-[0.25em] text-emerald-200">Limited
                            &middot; Promo Awal Peluncuran</span>
                    </div>
                </div>

                <div class="mt-16 grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
                    <article
                        class="reveal border-gold-500/40 from-ink-800/90 via-ink-900 to-ink-900 hover:border-gold-400/60 group relative overflow-hidden rounded-3xl border bg-gradient-to-br p-8 shadow-[0_30px_80px_-30px_rgba(212,167,44,0.4)] transition-all hover:shadow-[0_40px_100px_-30px_rgba(212,167,44,0.55)] sm:p-10"
                        style="--reveal-delay: 100ms;">
                        <div
                        ...
                        <div class="relative flex items-center justify-between">
                            <div
                                ...
                                <span
                                    class="text-gold-200 font-mono text-[10px] uppercase tracking-[0.25em]">Subscriber</span>
                            </div>
                            <span
                                class="from-gold-300 to-gold-500 text-ink-900 rounded-full bg-gradient-to-b px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em] shadow-[0_8px_24px_-8px_rgba(212,167,44,0.8)]">Most
                                Value</span>
                        </div>

                        <div class="relative mt-7">
                            <h3 class="font-display text-ink-50 text-3xl sm:text-4xl">Akses Penuh Bulanan</h3>
                            <p class="text-ink-200 mt-3 max-w-md text-sm leading-relaxed">Buka semua analisa aktif
                                tanpa batas, alert WhatsApp prioritas, dan live estimator selalu nyala.</p>
                        </div>
                        ...
                        <div
                            ...
                            <x-icon class="h-3.5 w-3.5 text-emerald-300" name="trending-up" />
                            <span class="font-mono text-[10px] uppercase tracking-[0.22em] text-emerald-200">5 analisa
                                = balik modal</span>
                        </div>

                        <ul class="relative mt-8 space-y-3">
                            @foreach (['Semua analisa aktif terbuka tanpa batas', 'Alert WhatsApp realtime saat TP / SL kena', 'Live profit estimator real-time', 'Arsip TP / SL terbuka selamanya', 'Akses ke semua signal baru selama subscription aktif'] as $perk)
                        ...
                        <p
                            ...
                            Bisa di-cancel kapan saja &middot; Tanpa auto-renew</p>
                    </article>
                    ...
                    <article
                        ...
                        <div class="relative flex items-center justify-between">
                            ...
                            <span
                                class="border-ink-600/70 bg-ink-800/60 text-ink-200 rounded-full border px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em]">Flexible</span>
                        </div>

                        <div class="relative mt-7">
                            <h3 class="font-display text-ink-50 text-3xl sm:text-4xl">Token Bayar per Buka</h3>
                            <p class="text-ink-200 mt-3 max-w-md text-sm leading-relaxed">Pilih cuma analisa yang kamu
                                suka. Bayar sekali, kebuka selamanya. Cocok buat yang mau coba dulu sebelum commit.</p>
                        </div>
                        ...
                        <p class="text-ink-300 relative mt-2 font-mono text-[11px] uppercase tracking-[0.18em]">Harga
                            sesuai potensi ROI signal</p>
                        ...
                        <p
                            class="text-ink-300 relative mt-4 text-center font-mono text-[10px] uppercase tracking-[0.22em]">
                            Bayar sekali &middot; Analisa kebuka selamanya</p>
                    </article>
                </div>
                ...
                <div class="reveal border-ink-700/60 bg-ink-900/70 mt-16 rounded-3xl border p-6 backdrop-blur-xl sm:p-8"
                    ...
                    <div class="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-end">
                        <div>
                            <div class="inline-flex items-center gap-3">
                                <span class="bg-gold-500/60 h-px w-8"></span>
                                <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Token
                                    Pack</span>
                            </div>
                            <h3 class="font-display text-ink-50 mt-3 text-2xl sm:text-3xl">Beli Banyak, Hemat Lebih
                                Banyak</h3>
                            <p class="text-ink-300 mt-2 max-w-xl text-sm leading-relaxed">Top-up sekali pakai
                                berkali-kali. Diskon makin gede tiap kelipatan paket.</p>
                        </div>
                        <span
                    ...
                    <div class="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                        @foreach ($tokenPacks as $pack)
                            ...
                            <div
                                class="{{ $featured ? 'border-gold-500/40 bg-gradient-to-b from-gold-500/10 to-transparent' : 'border-ink-700/70 bg-ink-800/40' }} hover:border-gold-500/40 hover:bg-ink-800/60 group relative overflow-hidden rounded-2xl border p-5 transition-all">
                                @if ($pack['badge'])
                                    <span
                                        class="{{ $featured ? 'bg-gradient-to-b from-gold-300 to-gold-500 text-ink-900' : 'border border-emerald-500/30 bg-emerald-500/10 text-emerald-200' }} absolute right-3 top-3 rounded-full px-2 py-0.5 font-mono text-[9px] uppercase tracking-[0.2em]">{{ $pack['badge'] }}</span>
                                @endif
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-ink-300 mt-1 text-xs leading-relaxed">Analisa yang dibuka tetap kebuka,
                                    walau signal sudah selesai.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <span
                                class="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-emerald-500/30 bg-emerald-500/10 text-emerald-200">
                                <x-icon class="h-4 w-4" name="activity" />
                            </span>
                            <div>
                                <div class="font-display text-ink-50 text-sm">Live Estimator</div>
                                <p class="text-ink-300 mt-1 text-xs leading-relaxed">Setiap analisa kebuka langsung
                                    dapat estimasi P/L real-time.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="reveal mt-12 flex flex-col items-center justify-center gap-3 text-center sm:flex-row sm:gap-6"
                    ...
                    <span class="text-ink-200 text-sm">Aktif tiap hari? Subscribe. Casual? Token. Sama-sama
                        hemat.</span>
                </div>
            </div>
        </section>
        ...
        <section class="landing-deferred relative scroll-mt-24 overflow-hidden py-32 sm:py-40" id="cta">
            ...
            <div class="relative mx-auto max-w-4xl px-6 text-center">
                <div class="reveal inline-flex items-center gap-3">
                    <span class="bg-gold-500/60 h-px w-10"></span>
                    <span class="text-gold-300 font-mono text-[10px] uppercase tracking-[0.3em]">Get Started</span>
                    <span class="bg-gold-500/60 h-px w-10"></span>
                </div>
                ...
                <p class="reveal text-ink-200 mx-auto mt-6 max-w-2xl text-base leading-relaxed"
                    style="--reveal-delay: 220ms;">Akses dashboard internal Weesia. Catat setiap analisa, ukur winrate
                    sebenarnya, dan lihat estimasi profit dalam satu meja kerja.</p>
                <div class="reveal mt-12 flex flex-wrap items-center justify-center gap-4"
                    style="--reveal-delay: 320ms;">
                    <a class="from-gold-300 to-gold-500 text-ink-900 group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-b px-8 py-4 text-sm font-semibold shadow-[0_18px_60px_-10px_rgba(212,167,44,0.6)] transition-all hover:shadow-[0_24px_80px_-10px_rgba(212,167,44,0.8)]"
                        href="{{ route('login') }}">
        ...
        <footer class="border-ink-700/60 bg-ink-900 relative border-t">
            <div class="mx-auto max-w-7xl px-6 py-14">
                <div class="flex flex-col items-start justify-between gap-10 md:flex-row md:items-center">
                    <div>
                        <div class="font-display text-ink-50 text-2xl">Weesia</div>
                        <div class="text-gold-300/80 mt-1 font-mono text-[10px] uppercase tracking-[0.3em]">FibPath
                            Analyzer</div>
                        <p class="text-ink-300 mt-4 max-w-sm text-sm leading-relaxed">Quantitative trading
                            intelligence. Disiplin sebelum diskresi, data sebelum opini.</p>
                    </div>
                ...
                <div
                    class="border-ink-700/60 text-ink-300 mt-14 flex flex-col items-start justify-between gap-4 border-t pt-6 text-xs sm:flex-row sm:items-center">
                    <span class="font-mono uppercase tracking-[0.2em]">&copy; {{ now()->year }} Weesia - All rights
                        reserved</span>
                    <span class="font-mono uppercase tracking-[0.2em]">Trading involves risk - Past performance is not
                        future results</span>
                </div>
            </div>
        </footer>
